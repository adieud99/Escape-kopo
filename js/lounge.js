...
function takeItem() {
    ...
    document.querySelectorAll('.hotspot').forEach(el => {
        if (el.getAttribute('onclick')?.includes(cur)) {
    ...
    if (s) {
        ...
        s.onclick = () => openItem(s.dataset.itemId); // 클릭 시 다시 열기
    }
    closePopup();
}
